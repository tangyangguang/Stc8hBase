...
- 日常快检入口为 `tools/check_examples.sh`，覆盖 host 测试、代表性 PlatformIO 示例和 Makefile 示例。
- 完整发布前验证入口为 `tools/check_examples_full.sh`，覆盖全部 PlatformIO 示例、专项符号检查、OTA 链接布局检查和 nRF24 尺寸 guard。

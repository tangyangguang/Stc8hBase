...
#define DRV_NRF24L01_CONFIGURE_PINS() do { \
    P1M0 &= (stc8h_u8)~(BOARD_NRF24L01_CSN_MASK | BOARD_NRF24L01_CE_MASK); \
    P1M1 &= (stc8h_u8)~(BOARD_NRF24L01_CSN_MASK | BOARD_NRF24L01_CE_MASK); \
    P1 |= (BOARD_NRF24L01_CSN_MASK | BOARD_NRF24L01_CE_MASK); \
    P3M0 &= (stc8h_u8)~BOARD_NRF24L01_IRQ_MASK; \
    P3M1 |= BOARD_NRF24L01_IRQ_MASK; \
    P3 |= BOARD_NRF24L01_IRQ_MASK; \
    P_SW2 |= 0x80u; \
    P3IE |= BOARD_NRF24L01_IRQ_MASK; \
} while (0)
